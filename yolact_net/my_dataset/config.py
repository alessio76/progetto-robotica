...
my_dataset = dataset_base.copy({
   'name': 'My Dataset',
    ...
    'train_images': './data/my_dataset/train/img',
    'valid_images': './data/my_dataset/val/img',
   

    'train_info': './data/my_dataset/train.json',
    'valid_info': './data/my_dataset/val.json',
...
my_yolact_ycb_config = yolact_resnet50_config.copy({
    'name': "yolact_resnet50",  # Will default to yolact_resnet50_pascal
